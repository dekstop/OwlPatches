...
//
//  TODO:
//  - don't just clip extreme values, instead add a simple limiter
//  - "horizontal sigmoid"-style parameter interpolation for bias control, atm it's a ramped step function with a sharp slope change in the centre
//
